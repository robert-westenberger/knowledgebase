...
In **message passing**, data objects can be thought of entities that receive "messages" that contain name of operations on that data that are being requested. 
