...
u1 = a u c {a,b,c,d} ∪ {c,d,e,f,l} = {a,b,c,d,e,f,l}.

u2 = b u d {c,d,e,f} ∪ {5,6,7,8,9,1} = {c,d,e,f,5,6,7,8,9,1}.

L = u1 x u2 = {{a,c},{a,d},{a,e},{a,f},{a,5},{a,6},{a,7},{a,8},{a,9},{a,1},{b,c},{b,d},{b,e},{b,f},{b,5},{b,6},{b,7},{b,8},{b,9},{b,1},{c,c},{c,d},{c,e},{c,f},{c,5},{c,6},{c,7},{c,8},{c,9},{c,1},{d,c},{d,d},{d,e},{d,f},{d,5},{d,6},{d,7},{d,8},{d,9},{d,1},{e,c},{e,d},{e,e},{e,f},{e,5},{e,6},{e,7},{e,8},{e,9},{e,1},{f,c},{f,d},{f,e},{f,f},{f,5},{f,6},{f,7},{f,8},{f,9},{f,1},{l,c},{l,d},{l,e},{l,f},{l,5},{l,6},{l,7},{l,8},{l,9},{l,1}}

cp1 = a x b = {{a,c},{a, d},{a, e },{a, f},{ b,c},{ b, d},{ b, e },{ b, f},{ c,c},{ c, d},{ c, e },{ c, f},{d,c},{d, d},{d, e },{d, f}}

cp2 = c x d = {{1,5},{1, 6},{1, 7},{1, 8},{1, 9 },{1, 1},{ 2,5},{ 2, 6},{ 2, 7},{ 2, 8},{ 2, 9 },{ 2, 1},{ 3,5},{ 3, 6},{ 3, 7},{ 3, 8},{ 3, 9 },{ 3, 1},{ 4,5},{ 4, 6},{ 4, 7},{ 4, 8},{ 4, 9 },{ 4, 1}}

r= = cp1 u cp2 = {{a,c},{a, d},{a, e },{a, f},{ b,c},{ b, d},{ b, e },{ b, f},{ c,c},{ c, d},{ c, e },{ c, f},{d,c},{d, d},{d, e },{d, f}, {1,5},{1, 6},{1, 7},{1, 8},{1, 9 },{1, 1},{ 2,5},{ 2, 6},{ 2, 7},{ 2, 8},{ 2, 9 },{ 2, 1},{ 3,5},{ 3, 6},{ 3, 7},{ 3, 8},{ 3, 9 },{ 3, 1},{ 4,5},{ 4, 6},{ 4, 7},{ 4, 8},{ 4, 9 },{ 4, 1}}